...
features_string <- sub("BodyBody", "Body", features_string)
### Removing "double body" in a couple of variables
...
summarised <- aggregate(filterdataset[ ,3:68], list(filterdataset$subject, filterdataset$activitycode), mean)
